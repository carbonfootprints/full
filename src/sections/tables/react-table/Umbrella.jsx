...
// third-party
import { DndContext, useSensor, useSensors, closestCenter, MouseSensor, TouchSensor, KeyboardSensor } from '@dnd-kit/core';
    ...
    <Stack direction="horizontal" gap={2} className="align-items-center justify-content-center">
      {meta?.selectedRow[row.id] && (
        <OverlayTrigger placement="bottom" overlay={<Tooltip>Cancel</Tooltip>}>
          <a href="#" className="btn-link-danger avatar avatar-xs " onClick={(e) => setSelectedRow(e)}>
