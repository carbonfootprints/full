...
const pricingPlans = Object.keys(prices).map((tab) => createPricingPlans(tab));

// ===============================|| PRICING CARD ||============================== //

const PricingCard = ({ name, services, price, lifetime, popular, enabledFeatures }) => {
  return (
    <Col md={6} lg={4}>
