...
export default function HTMLInputTypes() {
  ...
  const handleNumberChange = (e) => setNumberValue(parseInt(e.target.value));
  const handleTelChange = (e) => setTelValue(e.target.value);
  ...
  const handleWeekChange = (e) => setWeek(e.target.value);
  const handleColorChange = (e) => setColor(e.target.value);
  const handleRangeChange = (e) => setRange(parseInt(e.target.value));
