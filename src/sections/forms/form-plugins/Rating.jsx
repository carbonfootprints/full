...
export default function RatingMain() {
  ...
  const [ratingPrebuilt, setRatingPrebuilt] = useState();
  ...
  const [squareRating, setSquareRating] = useState(null);
  const [hideTooltipRating, setHideTooltipRating] = useState(null);
  ...
  const handleSquareRatingClick = (index) => {
    setSquareRating(index);
  };
  const handleHideTooltipRatingClick = (index) => {
