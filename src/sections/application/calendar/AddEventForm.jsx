...
export default function AddEventForm({ open, handleEventModal, selectedEvent }) {
...
AddEventForm.propTypes = { open: PropTypes.bool, handleEventModal: PropTypes.func, selectedEvent: PropTypes.any };
