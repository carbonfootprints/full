...
// ==============================|| CATEGORY 3.2.3a FORM ||============================== //

export default function Category3_2_3aForm() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: 'Category 3.2.3a data saved successfully. Results will be available once reviewed by the administrator.',
        timer: 2500
      });
      return true;
    } catch (error) {
  ...
  const handleSaveAndNext = async () => { if (await handleSave()) navigate('/calculate/carbon-footprint/category/3.2.3b'); };
      ...
      <MainCard>
        <Row className="align-items-center">
          <Col>
            ...
            <h4 className="mb-1">Category 3.2.3a - Downstream Road Transportation (Solid Wastes — Pernambut)</h4>
                      ...
                      {(site.consignments || []).map((c, ri) => {
                        ...
                        return (
                          <tr key={ri}>
                            ...
                            <td>
                              <Form.Control size="sm" type="text" placeholder="e.g., TP/144/24-25"
                                value={c.gatePass || ''}
                                onChange={(e) => updateRow(si, ri, 'gatePass', e.target.value)} />
                            </td>
                            <td>
                              <Form.Control size="sm" type="text" placeholder="e.g., TALCO"
                                value={c.agency || ''}
                                onChange={(e) => updateRow(si, ri, 'agency', e.target.value)} />
                            </td>
                            <td>
                              <Form.Control size="sm" type="text" placeholder="e.g., ETP SLUDGE"
                                value={c.wasteName || ''}
                            ...
                            <td>
                              <Form.Control size="sm" type="text" placeholder="e.g., PERNAMBUT"
                            ...
                            <td>
                              <Form.Control size="sm" type="text" placeholder="e.g., Paid"
      ...
      {calculations && resultsReleased && (
        <MainCard className="mt-3">
          ...
          <Card className="border-success">
            <Card.Header className="bg-success text-white fw-semibold">Grand Total — All Sites (Category 3.2.3a)</Card.Header>
            <Card.Body className="p-0">
              <Table bordered size="sm" className="mb-0">
                <thead className="table-light">
                  <tr>
