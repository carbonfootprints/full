  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (userType === 'orguser') {
        ...
        navigate('/admin-panel/orgusers/list', { replace: true });
      }
    } catch (err) {
              ...
              >
                <div className="text-center">
                  <div
                    ...
                    style={{ width: 80, height: 80, background: 'rgba(255,255,255,0.2)', borderRadius: '50%', fontSize: 36 }}
                  >
                    <i className="ph ph-leaf" />
                  </div>
                  <h3 className="fw-bold mb-3">PlanetCare</h3>
                  <p className="mb-4" style={{ opacity: 0.85, lineHeight: 1.6 }}>
                    Carbon Footprint Management Platform — track, manage, and reduce your organization's emissions.
                  </p>
                  <div className="d-flex flex-column gap-3 text-start">
                    {[
                      { icon: 'ph-chart-bar', text: 'Real-time emissions tracking' },
                      { icon: 'ph-buildings', text: 'Multi-site management' },
                      { icon: 'ph-file-text', text: 'PDF & Excel reports' },
                      { icon: 'ph-shield-check', text: 'Admin & organisation access' }
                    ].map((item, i) => (
                ...
                <Card.Body className="p-4 p-md-5">
                  <div className="text-center mb-4">
                    <div
                      ...
                      style={{ width: 56, height: 56, background: 'rgba(39,174,96,0.1)', borderRadius: '50%', color: '#27ae60', fontSize: 24 }}
                    >
